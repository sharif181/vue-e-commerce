    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if not user.is_active:
                messages.error(request, message='Your account is not active. Please active you account from given email, Otherwise contact with admin',
                               extra_tags='error')
...
class Profile(View):
    def get(self, request):
        return render(request, 'frontend/authentication/profile.html')
