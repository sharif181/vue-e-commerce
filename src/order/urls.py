...
from order.apis.order import RequestView, CheckDisposableEmail, RequestPartView, RequestDeleteView, \
    ApiRequestReviewView, ApiRequestReviewCreateView, OrderView, OrderDeleteView, GetOrderView, StripCheck
from rest_framework.routers import DefaultRouter

from order.apis.request import GetReviewIds, GetSelectedReview, SetSelectedReview, GetReviewIdInOrderInfo
from order.views import RequestReviewCreateView, RequestReviewView, RequestReviewEditView, RequestReviewDeleteView, \
    RequestReviewAttachmentDelete, RequestEstimationView, GetQuoteView, RequestOrderView, GetRequestInfo, CheckOutView, \
    OrderDetailsView, OrderUpdateView, RequestReviewSelectView, GetReviewInfo, SupplierReviewView, ModeratorReviewView, request_submit_helper
...
router.register(r'api/supplier/review', SupplierReviewView)
router.register(r'api/moderator/review', ModeratorReviewView)
...
urlpatterns = [
    ...
    path('api/get-review-ids/<int:request_id>', GetReviewIds.as_view()),
    ...
    # review list for supplier, moderator
    # path('api/supplier/review/<int:pk>', SupplierReviewView.as_view())
